package net.imjeck.client.config;
...
public class ContinuityConfig {
	...
	public static final ContinuityConfig INSTANCE = new ContinuityConfig(FMLPaths.CONFIGDIR.get().resolve("continuity_forged.json").toFile());
	static {
		INSTANCE.load();
	}
