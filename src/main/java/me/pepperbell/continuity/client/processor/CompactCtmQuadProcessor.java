...
public class CompactCtmQuadProcessor extends AbstractQuadProcessor {
	...
	public ProcessingResult processQuadInner(MutableQuadView quad, TextureAtlasSprite sprite, BlockAndTintGetter blockView, BlockState appearanceState, BlockState state, BlockPos pos, Supplier<Random> randomSupplier, int pass, ProcessingContext context) {
		...
		float un0 = Mth.getLerpProgress(quad.u(0), sprite.getU0(), sprite.getU1()) - 0.5f;
		float vn0 = Mth.getLerpProgress(quad.v(0), sprite.getV0(), sprite.getV1()) - 0.5f;
		float un1 = Mth.getLerpProgress(quad.u(1), sprite.getU0(), sprite.getU1()) - 0.5f;
		float vn1 = Mth.getLerpProgress(quad.v(1), sprite.getV0(), sprite.getV1()) - 0.5f;
		float un2 = Mth.getLerpProgress(quad.u(2), sprite.getU0(), sprite.getU1()) - 0.5f;
		float vn2 = Mth.getLerpProgress(quad.v(2), sprite.getV0(), sprite.getV1()) - 0.5f;
		float un3 = Mth.getLerpProgress(quad.u(3), sprite.getU0(), sprite.getU1()) - 0.5f;
		float vn3 = Mth.getLerpProgress(quad.v(3), sprite.getV0(), sprite.getV1()) - 0.5f;
		...
		if (uSplit & vSplit) {
			...
			if (split01 & split12 & split23 & split30) {
				...
				float delta4;
				if (uSplit01) {
					delta01 = Mth.getLerpProgress(0, un0, un1);
					delta23 = Mth.getLerpProgress(0, un2, un3);
					delta12 = Mth.getLerpProgress(0, vn1, vn2);
					delta30 = Mth.getLerpProgress(0, vn3, vn0);
					delta4 = Mth.getLerpProgress(0, Mth.lerp(delta01, vn0, vn1), Mth.lerp(delta23, vn2, vn3));
				} else {
					delta01 = Mth.getLerpProgress(0, vn0, vn1);
					delta23 = Mth.getLerpProgress(0, vn2, vn3);
					delta12 = Mth.getLerpProgress(0, un1, un2);
					delta30 = Mth.getLerpProgress(0, un3, un0);
					delta4 = Mth.getLerpProgress(0, Mth.lerp(delta01, un0, un1), Mth.lerp(delta23, un2, un3));
				}
				...
				if (splits == 2) {
					...
					if (!split01) {
						...
						if (uSplit01) {
							...
							delta12 = Mth.getLerpProgress(0, vn1, vn2);
							delta30 = Mth.getLerpProgress(0, vn3, vn0);
							delta4 = Mth.getLerpProgress(0, Mth.lerp(delta12, un1, un2), Mth.lerp(delta30, un3, un0));
						} else {
							delta23 = Mth.getLerpProgress(0, vn2, vn3);
							delta12 = Mth.getLerpProgress(0, un1, un2);
							delta30 = Mth.getLerpProgress(0, un3, un0);
							delta4 = Mth.getLerpProgress(0, Mth.lerp(delta12, vn1, vn2), Mth.lerp(delta30, vn3, vn0));
						}
