...
public class HorizontalSpriteProvider implements SpriteProvider {
	...
	protected int getConnections(Direction[] directions, BlockPos.Mutable mutablePos, BlockAndTintGetter blockView, BlockState appearanceState, BlockState state, BlockPos pos, Direction face, TextureAtlasSprite quadSprite) {
		int connections = 0;
		for (int i = 0; i < 2; i++) {
