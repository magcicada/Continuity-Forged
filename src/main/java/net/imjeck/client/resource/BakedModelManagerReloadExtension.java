...
public class BakedModelManagerReloadExtension {
	...
	public void beforeBaking(Map<ResourceLocation, AtlasSet.StitchResult> preparations, ModelBakery modelLoader) {
		...
		try {
			...
			((ModelLoaderExtension) modelLoader).continuity_forged$setModelWrappingHandler(null);
			return;
		}
		...
		((ModelLoaderExtension) modelLoader).continuity_forged$setModelWrappingHandler(wrappingHandler);
	}
