...
import net.imjeck.client.mixin.ReloadableResourceManagerImplAccessor;
...
public class ResourceRedirectHandler {
	public static final String SPRITE_PATH_START = "continuity_forged_reserved/";
	...
	public static ResourceRedirectHandler get(ResourceManager resourceManager) {
		...
		if (resourceManager instanceof MultiPackResourceManagerExtension extension) {
			return extension.continuity_forged$getRedirectHandler();
		}
		return null;
	}
