...
public interface ConnectionPredicate {
	...
	default boolean shouldConnect(BlockAndTintGetter blockView, BlockState appearanceState, BlockState state, BlockPos pos, BlockPos.Mutable otherPos, Direction face, TextureAtlasSprite quadSprite, boolean innerSeams) {
